...
import { businessSelectors, fetchBusinessById } from "@/application/reducers/business-reducer";
...
const Page = ({ params }: { params: { slug: string } }) => {
    ...
    }, [businessIdFromStorage, dispatch])
        ...
        <>
            <div className="flex flex-row h-screen bg-lightbg dark:bg-darkbg">
                <main className="w-full ">
                    ...
                    <div className="p-10">
                        {getLoading ? (
                            <p>Loading.. {params.slug} {businessIdFromStorage}</p>
                        )  : getBusiness ? (
                            <div className='flex flex-col justify-center items-center  rounded-xl p-10'>
                                <div className='text-5xl '>Welcome to <span className='font-bold'> {getBusiness.name}</span> </div>
